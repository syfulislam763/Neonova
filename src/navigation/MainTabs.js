   ...
   return (
    <Tab.Navigator
        screenOptions={({ route }) => {
            ...
            const hiddenRoutes = ["ProductDetailScreen", "ProfileScreen", "FullProfileScreen", "EditProfileScreen", "MyTrainingSessionScreen", "SubscriptionScreen", "PrivacyPolicyScreen", "MessagingScreen", "ChatConversationScreen", "CreatePostScreen", "UserProfileScreen", "OrderCard", "AddProductScreen", "AddProductScreenTwo", "UploadTrainingScreen", "EpisodeScreen"];
